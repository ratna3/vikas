  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 border-2 border-gray-200 rounded-full hover:bg-gray-100 hover:border-gray-300 transition-all"
      ...
      {showShareMenu && (
        <>
          ...
          />
          <div className="absolute bottom-full left-0 mb-2 bg-white rounded-xl shadow-xl border border-gray-100 p-3 z-50 min-w-[200px]">
